...
class ZKGlucoseProof:
    ...
    def __init__(self, secret_key=None):
        ...
        """
        # Generates random secret key if not provided
...
# Importing pandas here because I want to avoid issues with circular imports
import pandas as pd


# Regardless if this is ever used irl, I'm very proud of how I structured this codebase and documentation. 
# Time to keep changin the world and whatever type beat, ok I'm tired - Peyton