...
class DiabetesModel:
    ...
    def train(self, processed_data):
        ...
        # Create copies to avoid warnings (was getting annoyed, doesn't seem detrimental)
        ...
        # Trains glucose prediction model
        glucose_metrics = self._train_glucose_model(X_glucose)
        
        # Trains hypoglycemia prediction model
    ...
    def _prepare_glucose_prediction_data(self, data):
        ...
        # Create target, glucose value 30 minutes ahead (6 readings because of 5 min intervals)
    ...
    def _prepare_hypoglycemia_prediction_data(self, data):
        ...
        window_size = 6  # 30 minutes (6 readings)
    ...
    def generate_insights(self, data):
        ...
        if above_range_pct > 25:
            recommendations.append("Your time above range is higher than ideal. Consider carb precision and timing insulin at least 15 minutes before eating.")
