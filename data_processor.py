...
def preprocess_dexcom_data(df):
    ...
    # Dexcom column names: 'Timestamp', 'Glucose Value (mg/dL)', 'Event Type'
    # Or maybe: 'timestamp', 'glucose', 'event_type'
    # idk just trying to think of test cases
    ...
    if glucose_cols:
        ...
        if len(numeric_cols) > 0:
            ...
            raise ValueError("Can't identify glucose value column in the data")
